...
#     from sglang.srt.layers.attention.linear.kernels.fused_sigmoid_gating_recurrent import fused_sigmoid_gating_delta_rule_update_npu
...
class TritonKDAKernel(LinearAttnKernelBase):
    ...
    def decode(
        ...
        **kwargs,
        ...
        # Save state before decode for torch reference comparison

        out_npu = fused_sigmoid_gating_delta_rule_update(
            A_log=A_log,
            dt_bias=dt_bias,
            q=q,
            k=k,
    ...
    def extend(
        ...
        **kwargs,
        ...
        # Save original ssm_states for comparison, then run Triton.
